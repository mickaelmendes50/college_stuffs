/*
 * Trabalho 1 - Transformacoes 2D - Computação Gráfica 2023/02
 *
 * Alunos: Felipe Gabriel
 *		   Giovana Ferreira
 * 		   Mickael Mesquita
 *
...
void desenha(){
	...
	//Desenha o triângulo original com cor branca
	...
	//Desenha triângulo transladado, rotacionado e escalado com cor vermelha
...
int main(int argc, char ** argv){
	...
	glutCreateWindow("Trabalho 2 - 1. Transformacoes 2D");
	inicializa();
