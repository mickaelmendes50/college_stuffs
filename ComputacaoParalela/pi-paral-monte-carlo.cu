...
__global__ void monteCarloPI_parallel(int *count, int N) {
    ...
    // Dividindo o total de iterações entre todas as threads
...
int main() {
    ...
    monteCarloPI_parallel<<<1024, 1024>>>(device_count, N);
